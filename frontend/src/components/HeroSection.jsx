...
const HeroSection = () => {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-background-dark pt-14">
      {/* First Section */}
      <div className="relative h-screen w-full flex">
        ...
        <div className="w-1/2 flex flex-col items-start justify-center text-white px-16 mb-6 z-10">
