...
const ReportPDF = ({ results, patientInfo }) => {
  ...
  // Use provided patient info or fallback to empty values
  ...
  // Calculate values for additional metrics
  ...
  // Determine severity and tumor profile
  let severity = "low";
  ...
  // Determine tumor profile based on component distribution
  ...
  // Get general recommendations based on severity and profile
